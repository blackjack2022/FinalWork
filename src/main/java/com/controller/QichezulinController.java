...
public class QichezulinController {
    ...
    public R page(@RequestParam Map<String, Object> params,QichezulinEntity qichezulin,
		...
		if(tableName.equals("yonghu")) {
			qichezulin.setZhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R query(QichezulinEntity qichezulin){
		...
		return R.ok("查询电动车租赁成功").put("data", qichezulinView);
    }
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<QichezulinEntity> list = new ArrayList<QichezulinEntity>();
        for(Long id : ids) {
            QichezulinEntity qichezulin = qichezulinService.selectById(id);
            qichezulin.setSfsh(sfsh);
            qichezulin.setShhf(shhf);
            list.add(qichezulin);
        }
        qichezulinService.updateBatchById(list);
        return R.ok();
    }
