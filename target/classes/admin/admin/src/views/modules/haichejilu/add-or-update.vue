	...
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#555","borderRadius":"0 0 10px 10px","background":"rgba(255,255,255,.69)","width":"86%","fontSize":"16px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="检查状态" prop="jianchazhuangtai">
					<el-select :disabled="ro.jianchazhuangtai" v-model="ruleForm.jianchazhuangtai" placeholder="请选择检查状态" >
						<el-option
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="检查状态" prop="jianchazhuangtai">
					<el-input v-model="ruleForm.jianchazhuangtai"
						placeholder="检查状态" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="归还备注" prop="guihaibeizhu">
					<el-input
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.guihaibeizhu" label="归还备注" prop="guihaibeizhu">
					<span :style='{"fontSize":"14px","lineHeight":"24px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.guihaibeizhu}}</span>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.jianchazhuangtai = '未检查'; 			}
			// 获取用户信息
			this.$http({
