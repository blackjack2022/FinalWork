<template>
	<div class="menu-preview">
		...
		<el-menu :default-active="activeMenu" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","whiteSpace":"nowrap","background":"none","display":"flex","width":"100%","position":"inherit","transition":"all 0s ease"}' mode="horizontal" class="el-menu-horizontal-2">
